...
function EventTooltip({ ev, cellRef }) {
  ...
  return (
    <div style={{
      ...
      {ev.description && (
        <div style={{ color: '#cbd5e1', fontSize: '0.68rem', marginTop: '4px', borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: '4px', maxWidth: '250px', whiteSpace: 'normal' }}>

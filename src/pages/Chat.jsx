...
export default function Chat() {
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  {preview && <span style={{ fontSize: '0.7rem', color: '#94a3b8' }}>{formatTime(preview.createdAt)}</span>}
                </div>
                <div style={{
  ...
  const chatHeader = selectedContact ? (
    <div style={{
      ...
      display: 'flex', alignItems: 'center', gap: '0.75rem', background: '#fafbfc'
    }}>
      <button
  ...
  const chatMessages = (
    <div style={{ flex: 1, minHeight: 0, overflowY: 'auto', padding: '1.25rem', background: '#f8fafc' }}>
  ...
  const conversationPanel = (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: 'white', minWidth: 0, height: '100%' }}>
      {!selectedContact ? (
        <div style={{

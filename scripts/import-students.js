...
students.forEach(s => {
  ...
  const address = (s.address || s['DIRECCIÓN'] || '').replace(/'/g, "''");

  console.log(`INSERT INTO students (id, name, dni, class_id, guardian_name, guardian_dni, guardian_phone, birth_date, address) VALUES ('${id}', '${name}', '${dni}', '${classId}', '${guardianName}', '${guardianDni}', '${guardianPhone}', '${birthDate}', '${address}');`);
});
